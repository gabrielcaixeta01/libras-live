"""Loop do alfabeto: liga câmera, detector, classificador, estabilizador e UI.

    python -m libras.app              # soletrar: sua mão vira texto
    python -m libras.app --praticar   # praticar: ele pede a letra, você faz

Quem analisa os argumentos e escolhe o modo é `libras/app.py`. Aqui só mora o
laço — sete peças conversando por frame, e nenhum `if` sobre qual app é este.
"""
