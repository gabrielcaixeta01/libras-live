...
from .sinais.dicionario import Candidato
from .sinais.segmenter import Estado
from .ui import AMARELO, AZUL, BRANCO, CINZA, CINZA_ESCURO, FONTE, PRETO, VERDE, _faixa
...
def desenhar_candidatos(
    ...
    _faixa(frame, topo, altura, opacidade=0.7)
